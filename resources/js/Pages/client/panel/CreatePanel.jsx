...
import { FaCircleInfo, FaRegCircleUser, FaLock, FaTv, FaCheck, FaRegCircleXmark, FaFileInvoiceDollar, FaRegCreditCard, FaPenClip } from "react-icons/fa6";
...
export default function CreatePanel({ ...props }) {
    ...
    const handleDelet = (RequestID) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.post(`/client/delet-panel/${RequestID}`,
                    {
    ...
    const handleSearch = (e) => {
        ...
        router.post(route('client.getPanel'),
            payload,
            {
                preserveScroll: true,
                preserveState: true,
                        ...
                        <div className="p-4 overflow-y-auto">
                            <form onSubmit={handleSubmit} >
                                ...
                                <div className="mb-4">
                                    ...
                                    <input type="text" value={data.password} onChange={handleChange} name='password' className="peer py-3 px-4 ps-11 block w-full bg-gray-100 border-transparent rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-700 dark:border-transparent dark:text-gray-400 dark:focus:ring-gray-600" />
                                </div>
