...
import { FaFileInvoiceDollar, FaRegCreditCard, FaTv, FaPlay, FaCirclePlus } from "react-icons/fa6";
import Swal from 'sweetalert2';

export default function Welcome({ auth, service }) {
    ...
    const modalOther = () => {
        if (isBrowser) {
            HSOverlay.open('#hs-slide-up-animation-modal');
        }
    };
    return (
        <>
                ...
                <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                    <div className="pl-4 flex items-center">
                        <a className="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
                            <FaPlay className="h-7 fill-current inline align-middle" />
                            IP-TV services
                        </a>
                    </div>
            ...
            <div className="pt-24">
                <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                    <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                        <p className="uppercase tracking-loose w-full">Welcome to our IPTV panel!</p>
                        <h1 className="my-4 text-5xl font-bold leading-tight">
                            Get access to premium TV channels.
                        </h1>
                        <p className="leading-normal text-2xl mb-8">
                            Enjoy high-quality streaming with our IPTV services.
                        </p>
                        <Link href={route('register')} className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                            Subscribe
                        </Link>
                    </div>
                    <div className="w-full md:w-3/5 py-6 text-center">
                        <img className="w-full md:w-4/5 z-50" src='media/hero.png' />
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-5/6 sm:w-1/2 p-6">
                            ...
                            <p className="text-gray-600 mb-8">
                                Our IPTV service offers unparalleled accessibility, allowing you to enjoy your favorite content from anywhere around the globe. Whether you're at home, traveling.
                                <br />
                                <br />
                            </p>
                        </div>
                        <div className="w-full sm:w-1/2 p-6">
                            <svg className="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                                <title>Unrestricted Entertainment</title>
                                <path
                    ...
                    <div className="flex flex-wrap flex-col-reverse sm:flex-row">
                        <div className="w-full sm:w-1/2 p-6 mt-6">
                            <svg className="w-5/6 sm:h-64 mx-auto" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
                                <title>IPTV Gateway to Global Viewing</title>
                                <path
                        ...
                        <div className="w-full sm:w-1/2 p-6 mt-6">
                            <div className="align-middle">
                                <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">
                                    IPTV Gateway to Global Viewing
                                </h3>
                                <p className="text-gray-600 mb-8">
                                    Our IPTV solution boasts global accessibility, functioning flawlessly in any environment.
                                    or in a different country, our platform ensures seamless streaming experiences across various devices.
                                    <br />
            ...
            <section className="bg-white border-b py-8">
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
                        {services.length !== 0 &&
                            services.map((value, index) => (
                                <button className="relative" key={index} onClick={() => modalAction()}>
                                    <div className="w-full max-w-xs relative shadow-2xl shadow-indigo-300 overflow-hidden group">
                                        <div className="absolute -bottom-10 group-hover:top-0 left-0 w-full h-full group-hover:bg-indigo-500 transition-all ease-in-out duration-500">
                                            <div className="w-full h-full p-3 relative">
                                                <div className="absolute bottom-0 group-hover:bottom-16 text-white text-left transition-all ease-in-out duration-500">
                                                    <h2 className="text-lg font-bold text-white mb-0 pb-1">{value.name}</h2>
                                                    <h3 className="text-lg font-bold text-white mb-0 pb-1 inline-block mr-2">{value.price} €</h3>
                                                    <p className="text-sm font-light text-white crossed-out inline-block">{value.old_price} €</p>
                                                    <p className="text-sm font-light text-white">{value.description}. see more..</p>
                                                </div>
                                            </div>
                                        </div>
                                        <img src={value.logo} className="w-full h-48 object-fill example" />
                                    </div>
                                </button>
                            ))}
                        <Link className="relative" href={route('register')}>
                            <div className="w-full max-w-xs relative shadow-2xl shadow-indigo-300 overflow-hidden group">
                                <img src='media/wp7559469.webp' className="w-full h-48 object-fill example" />
                                <div className="absolute inset-0 flex items-center justify-center ">
                                    <div className="flex items-center">
                                        <h2 className="text-lg font-bold text-white bg-black bg-opacity-50 px-3 py-1">Other Services</h2>
                                        <FaCirclePlus className="ml-2 text-white" />
                                    </div>
                                </div>
                                <div className="absolute bottom-0 left-0 w-full h-full p-3 group-hover:top-0 group-hover:bg-indigo-500 transition-all ease-in-out duration-500">
                                    <div className="absolute bottom-0 group-hover:bottom-16 text-white text-left transition-all ease-in-out duration-500">
                                        <p className="text-sm font-light text-white">If you can't find the desired service, click below for assistance.</p>
                                    </div>
                                </div>
                            </div>
                        </Link>
                ...
                {/* <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap -m-4 text-center">
                        {services.length !== 0 &&
                            services.map((value, index) => (
                                <div key={index} className="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500">
                                    <div className="flex items-center justify-between p-4 rounded-lg bg-white shadow-indigo-50 shadow-md">
                                        <div>
                                            <h2 className="text-gray-900 text-lg font-bold">{value.name}</h2>
                                            <h3 className="mt-2 text-xl font-bold text-indigo-500 text-center">{value.price} €/Mon</h3>
                                            <p className="text-sm font-semibold text-gray-400">{value.description}</p>
                                            <button className="text-sm mt-6 px-4 py-2 bg-indigo-400 text-white rounded-lg  tracking-wider hover:bg-indigo-500 outline-none" onClick={() => modalAction()}>Action</button>
                                        </div>
                                        <div className="bg-gradient-to-tr w-32 h-32 rounded-full shadow-2xl border-white border-dashed border-2 flex justify-center items-center">
                                            <div>
                                                <img className="text-2xl" src={value.logo} alt={value.name} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                        <div className="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                                    ...
                                    <div className="!z-5 relative flex h-full w-full flex-col rounded-[20px] bg-white bg-clip-border p-4 shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
                                        <div className="mb-8 w-full">
                                            ...
                                            <p className="mt-2 text-base text-gray-600">
                                                Here you can find actions you can perform. Register to access more features and perform actions in our system.
                                            </p>
                                        </div>
                                        <div className="flex w-full items-center justify-between rounded-2xl bg-white p-3 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <p className="mt-2 text-sm text-gray-600"> You can request credits for your panel from the administrator.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex w-full items-center justify-between rounded-2xl bg-white p-3 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <p className="mt-2 text-sm text-gray-600"> tart a new panel or project within the system to manage your tasks or data efficiently.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex w-full items-center justify-between rounded-2xl bg-white p-3 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <p className="mt-2 text-sm text-gray-600"> Complete your transactions securely and efficiently through our payment system..</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-gray-700">
                                ...
                                <Link onClick={(e) => { closeModal(); }} href={route('register')} className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-indigo-500 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                    Register
                                </Link>
                            </div>
                        </div>
            ...
            <section className="container mx-auto text-center py-6 mb-12">
                ...
                <h3 className="my-4 text-3xl leading-tight">
                    Embrace Limitless Viewing with Our IPTV Service!
                </h3>
                <Link href={route('register')} className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    Action!
                </Link>
