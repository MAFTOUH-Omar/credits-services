...
export default function TicketList({ ...props }) {
    ...
    const modalAction = (value) => {
        ...
        if (isBrowser) {
            setData({...data, ticket_id: value.id});
            setModalInfos(value);
    ...
    const handleReject = () => {
        ...
        setData(prevData => ({ ...prevData, status: 'Rejected' }));
    };
    ...
    const handleSearch = (e) => {
        ...
        router.post(route('admin.getTicket'),
            payload,
            {
                preserveScroll: true,
                preserveState: true,
                                ...
                                <div aria-label="content" className="grid gap-3">
                                    ...
                                    <div className="flex items-center space-x-4 p-3.5 rounded-full bg-gray-100">
                                        ...
                                        <div className="flex flex-col flex-1">
                                            ...
                                            <div className="divide-x divide-gray-200 mt-auto">
                                                <span className="inline-block px-3 text-sm leading-none text-gray-500 font-medium first:pl-0">{modalInfos?.message}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex items-center space-x-4 p-3.5 rounded-full bg-gray-100">
                                            ...
                                            {showRejectForm && (
                                                <div>
                                                    <div className="flex flex-col">
                                                        <label htmlFor="message" className="fs-6 form-label fw-bold text-gray-900">Message:</label>
                                                        <textarea
                                                            id="message"
