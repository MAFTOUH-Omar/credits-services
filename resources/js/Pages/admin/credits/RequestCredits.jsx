...
import { FaCircleInfo, FaRegCircleUser, FaCircleCheck, FaTv, FaCheck, FaRegCircleXmark, FaCreditCard, FaRegCreditCard } from "react-icons/fa6";
...
export default function RequestCredits({ ...props }) {
    ...
    const handleAccept = (value) => {
        ...
        //console.log(newData);
        router.post('/admin/response-credit', newData)
    };
    const optionsStatus = [
        { value: 1, label: 'All' },
    ...
    const paidPanel = (valueId) => {
        router.post(`/admin/paid-credit/${valueId}`,
            {
                preserveScroll: true,
                preserveState: true,
    ...
    const handleSubmit = (event) => {
        ...
        const newData = { id: data.id, client_id: data.client_id, status: 'Rejected', rejectReason: rejectReason };
        // console.log(newData);
        router.post('/admin/response-credit', newData);
        closeModal();
    };
    const handleSearch = (e) => {
        ...
        router.post(route('admin.getCredit'),
            payload,
            {
                preserveScroll: true,
                preserveState: true,
